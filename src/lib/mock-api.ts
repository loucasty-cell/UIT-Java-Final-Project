...
const DEFAULT_MENTORS: MentorDetailResponse[] = [
  {
    ...
    skills: [
      { id: "sk-react", name: "React", category: "Programming", level: "ADVANCED", direction: "TEACH" },
      { id: "sk-typescript", name: "TypeScript", category: "Programming", level: "ADVANCED", direction: "TEACH" },
      { id: "sk-uiux", name: "UI/UX & Figma", category: "Design", level: "INTERMEDIATE", direction: "TEACH" },
    ],
  },
  {
    id: "m-marcus",
    ...
    skills: [
      { id: "sk-algebra", name: "Linear Algebra", category: "Mathematics", level: "ADVANCED", direction: "TEACH" },
      { id: "sk-calculus", name: "Calculus & Analysis", category: "Mathematics", level: "ADVANCED", direction: "TEACH" },
      { id: "sk-python", name: "Python", category: "Programming", level: "INTERMEDIATE", direction: "TEACH" },
    ],
  },
  {
    id: "m-kenji",
    ...
    modes: ["points", "exchange"],
    skills: [
      { id: "sk-uiux", name: "UI/UX & Figma", category: "Design", level: "ADVANCED", direction: "TEACH" },
    ],
  },
];
...
function initDB(): MockDB {
  ...
  const initialDB: MockDB = {
    ...
    userSkills: {
      "user-student": [
        { id: "us-1", skillId: "sk-react", skillName: "React", category: "Programming", level: "INTERMEDIATE", direction: "TEACH", verified: true },
        { id: "us-2", skillId: "sk-algebra", skillName: "Linear Algebra", category: "Mathematics", level: "BEGINNER", direction: "LEARN", verified: false },
      ],
      "user-mentor": [
        { id: "us-3", skillId: "sk-react", skillName: "React", category: "Programming", level: "ADVANCED", direction: "TEACH", verified: true },
        { id: "us-4", skillId: "sk-typescript", skillName: "TypeScript", category: "Programming", level: "ADVANCED", direction: "TEACH", verified: true },
      ],
    },
  ...
  if (cleanPath === "/api/v1/me/mentor-offerings") {
    if (method === "POST") {
      const newOffering: MentorOfferingResponse = {
        ...
        title: body.title || "Custom Mentorship",
  ...
  if (cleanPath === "/api/v1/me/skills") {
    ...
    if (method === "POST") {
      const added: UserSkillResponse = {
        id: "us-" + Date.now(),
        skillId: body.skillId || "sk-react",
        skillName: body.skillName || "Added Skill",
  ...
  if (cleanPath === "/api/v1/sessions" || cleanPath === "/api/v1/me/sessions") {
    if (method === "POST") {
      const newSession: SessionResponse = {
        ...
        status: "PENDING",
        pointsTransferred: body.pointsTransferred || 40,
  ...
  if (cleanPath === "/api/v1/swaps" || cleanPath === "/api/v1/me/swaps") {
    if (method === "POST") {
      const newSwap: SwapRequestResponse = {
        id: "swap-" + Date.now(),
        requesterId: db.users[0].id,
        requesterName: db.users[0].displayName,
        receiverId: body.receiverId || "user-marcus",
        receiverName: "Marcus Delgado",
        offeredSkillName: body.offeredSkillName || "React",
        requestedSkillName: body.requestedSkillName || "Linear Algebra",
        status: "PROPOSED",
